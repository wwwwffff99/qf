...
public class UserController {
    ...
    ResponseMessage login(@RequestBody User user) {
        ...
        System.out.println(subject.toString()+"1111111111111111111");
        if (!subject.isAuthenticated()) {
            ...
            try {
                ...
                System.out.println(principal.getRoles()+"2222222222222222222");
                System.out.println(user.getRoles().iterator().next().getRoleId()+"3333333333333333333");
                System.out.println(user.getRoles().iterator().next().toString()+"44444444444444444");
